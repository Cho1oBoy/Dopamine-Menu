...
const problemPoints = [
  "Бесконечный скролл, который съедает вечер",
  "Shorts, TikTok и Reels вместо пары минут отдыха",
  "Прокрастинация перед учёбой, экзаменом или задачей",
  "Утренний телефонный автопилот до того, как начался день",
  "Импульсивные покупки, сладкое и фастфуд на эмоциях"
];
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--ink-soft)]">Спокойная пауза перед быстрым дофамином</p>
              </div>
              <Link
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="max-w-3xl text-[2.5rem] font-bold leading-[0.92] tracking-[-0.07em] text-[var(--ink)] sm:text-[4.4rem]">
                  Когда тянет залипнуть — выбери здоровый дофамин
                </h1>
        ...
        <section className="space-y-4" id="problem">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
            {problemPoints.map((item) => (
              <Card key={item} className="min-h-[10.5rem] border-[rgba(120,83,66,0.08)] bg-white/84 p-5">
                <div className="flex h-full flex-col justify-between gap-6">
                  <div className="h-10 w-10 rounded-2xl bg-[rgba(216,116,90,0.10)]" />
        ...
        <section className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]" id="how-it-works">
          <Card className="border-[rgba(198,113,87,0.14)] bg-[linear-gradient(160deg,rgba(255,251,248,0.96),rgba(255,238,229,0.92))] p-6 sm:p-7">
            <div className="space-y-4">
              ...
              <h2 className="text-[2rem] font-semibold leading-[1] tracking-[-0.05em] text-[var(--ink)] sm:text-[3rem]">
                Приложение не запрещает. Оно помогает переключиться.
              </h2>
